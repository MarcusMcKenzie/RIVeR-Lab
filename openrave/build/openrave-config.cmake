...
if( MSVC )
  ...
  set(OpenRAVE_LIBRARY_SUFFIX "0.15" CACHE STRING "the suffix for the openrave libraries" FORCE)
endif()
...
set( OpenRAVE_INCLUDE_DIRS "${OpenRAVE_ROOT_DIR}/include/openrave-0.15")
...
if(1)
  set( OpenRAVE_PYTHON_DIR "${OpenRAVE_ROOT_DIR}/lib/python2.7/dist-packages/openravepy/_openravepy_0_9")
  mark_as_advanced(OpenRAVE_PYTHON_DIR)
endif()

set( OpenRAVE_Boost_VERSION "1.58")
